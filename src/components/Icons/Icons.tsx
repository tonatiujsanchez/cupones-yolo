...
export const FacebookIcon: FC<IconProps> = ({ color = COLORS.PRIMARY }) => {
    return (
        <svg
...
export const InstagramIcon: FC<IconProps> = ({ color = COLORS.PRIMARY }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
...
export const WhatsAppIcon: FC<IconProps> = ({ color = COLORS.PRIMARY }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25" height="25" viewBox="0 0 24 24"
